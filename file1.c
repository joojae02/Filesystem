...
void filesave() {
	...
	fwrite(inode, sizeof(struct inode) , 128, f);
	fwrite(datablock, sizeof(struct datablock), 256, f);
...
void fileread() {
	...
	fread(inode, sizeof(struct inode), 128, f);
	fread(datablock, sizeof(struct datablock), 256, f);
